...
<div id="primary" class="content-area">
    ...
    <h1 class = "Titre" > Question 4 - Les cours du programme de Techniques d intégration multimédia du collège de Maisonneuve </h1>
...
<footer> 
    <p class = "footer">Épreuve Finale – Veille technologique</p>
</footer>